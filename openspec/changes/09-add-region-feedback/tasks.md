...
- [ ] 2.1 Add `activeRegions` and `eliminatedRegions` state to game store
- [ ] 2.2 Update region state when geographic answers are given
- [ ] 2.3 Expose region state from game store

## 3. Animations

- [ ] 3.1 Implement fade-out animation for eliminated regions (via opacity paint property)
- [ ] 3.2 Implement highlight animation for confirmed regions (green color)
- [ ] 3.3 Use MapLibre paint property for state-based styling

## 4. Integration

- [ ] 4.1 Connect to game store for answer events
- [ ] 4.2 Update region visibility when regions prop changes
- [ ] 4.3 Clear all regions when component unmounts
