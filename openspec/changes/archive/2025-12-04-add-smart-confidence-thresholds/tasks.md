...
- [x] 1.1 Add new config keys to `supabase/seeds/00_static_data.sql`:
...
- [x] 1.2 Remove old config keys from seed:
...
- [x] 2.1 Create `supabase/db/game_logic/functions/algorithm/calculate_dynamic_threshold.sql`:
...
- [x] 3.1 Modify `supabase/db/game_logic/functions/algorithm/should_guess.sql`:
...
- [x] 4.1 Modify `supabase/db/game_logic/functions/handle_question.sql`:
...
- [x] 5.1 Verify `supabase/db/game_logic/functions/handle_question.sql`:
...
- [x] 6.1 Modify `supabase/db/game_logic/functions/decide_next_turn.sql`:
...
- [x] 7.1 Update `supabase/tests/test_algorithm_functions.sql`:
...
- [x] 7.2 Update `supabase/tests/test_settings_control_behavior.sql`:
  - Update any tests referencing old config keys

## 8. Rebuild and Verify

- [x] 8.1 Run `bun run db:rebuild` to regenerate migration
- [x] 8.2 Run `bun run test:db` to verify all tests pass
- [x] 8.3 Test via SQL gameplay: verify confidence sums to 100% after each turn
- [x] 8.4 Test via SQL gameplay: verify dynamic threshold affects guess timing
