...
[![Security](https://github.com/discountedcookie/10x-mapmaster/actions/workflows/security.yml/badge.svg)](https://github.com/discountedcookie/10x-mapmaster/actions/workflows/security.yml)
...
| 🔒 **CodeQL** | [![Security](https://github.com/discountedcookie/10x-mapmaster/actions/workflows/security.yml/badge.svg)](https://github.com/discountedcookie/10x-mapmaster/security/code-scanning) | Code vulnerability scanning | [View Alerts](https://github.com/discountedcookie/10x-mapmaster/security/code-scanning) |
| 🛡️ **Semgrep** | [![Security](https://github.com/discountedcookie/10x-mapmaster/actions/workflows/security.yml/badge.svg)](https://github.com/discountedcookie/10x-mapmaster/actions/workflows/security.yml) | Static security analysis | [View Workflow](https://github.com/discountedcookie/10x-mapmaster/actions/workflows/security.yml) |
